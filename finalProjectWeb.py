...
def predict(movies_data):
    ...
    result_stats["Grid Search"]=rootMeanSquaredError1
...
if __name__=='__main__':
    ...
    movies_data = pandas.read_table('rotten.txt',sep='\t')
